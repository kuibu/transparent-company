...
DEFAULT_GOVERNANCE_POLICY = GovernancePolicy(
    ...
    rules=[
        ...
        _allow_rule("allow_event_skill_run_started", "event:SkillRunStarted", "Allow skill execution start audit", ["agent", "human", "system"]),
        _allow_rule("allow_event_skill_run_finished", "event:SkillRunFinished", "Allow skill execution finish audit", ["agent", "human", "system"]),
        _allow_rule("allow_event_skill_run_failed", "event:SkillRunFailed", "Allow skill execution failure audit", ["agent", "human", "system"]),
